...
def remove_frontend_files():
    """
    Removes files needed for ReactJS, Redux, Webpack
    """
    shutil.rmtree(os.path.join(
...
# 6. Removes all front-end files if it isn't going to be used
if '{{ cookiecutter.setup_reactjs}}'.lower() == 'n':
...
if '{{ cookiecutter.setup_reactjs }}'.lower() == 'y' and '{{ cookiecutter.use_docker }}'.lower() == 'y':
    print(
        "You selected to use docker and set up front-end. This is NOT supported out of the box for now. You "
