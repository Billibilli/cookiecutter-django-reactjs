...
* LDAP users will be able to login using their LDAP credentials
...
* To promote a LDAP account to a **superuser account**, use this command::
...
Running tests quickly with py.test
~~~~~~~~~~~~~~~~~~~~~~~~~~
